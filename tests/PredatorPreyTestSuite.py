...
test_prey = unittest.TestLoader().loadTestsFromTestCase(PreyTest)
test_suite = unittest.TestSuite([test_grid_pawn_env,test_predator, test_coord, test_pred_prey_grid_environ, test_prey]) 
